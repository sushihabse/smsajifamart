    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="">
                ...
                <img src="{{asset('/')}}website/assets/imgs/theme/logo.svg" class="header-brand-img light-logo1" alt="logo">
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('order.index')}}" class="slide-item">Manage Orders</a></li>
                        <li><a href="" class="slide-item">Manage Returns</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">In House Products</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Seller Products</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Charts</a></li>
                        <li><a href="" class="slide-item"> Main Banner </a></li>
                        <li><a href="" class="slide-item">Footer Banner</a></li>
                        <li><a href="" class="slide-item">Popup Banner</a></li>
                        <li><a href="" class="slide-item">Main Section</a></li>
                        <li><a href="" class="slide-item"> Banner</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Offers & Deals</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Icons</a></li>
                        <li><a href="" class="slide-item">Coupon</a></li>
                        <li><a href="" class="slide-item"> Flash Deals</a></li>
                        <li><a href="" class="slide-item"> Deal of the day</a></li>
                        <li><a href="" class="slide-item"> Featured Deal</a></li>
                        <li><a href="" class="slide-item"> Free Shipping</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Push Notification</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
